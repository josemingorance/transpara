            ...
            <div className="flex gap-1 flex-wrap">
              {data.map((day, idx) => {
                ...
                return (
                  ...
                  >
                    <div
                      className="w-4 h-4 rounded-sm cursor-pointer hover:ring-2 hover:ring-blue-500 hover:ring-offset-2 transition-all"
                      style={{
                    ...
                    {/* Tooltip */}
                    {hoveredCell === idx && (
                      <div className="absolute z-10 bottom-full left-1/2 transform -translate-x-1/2 mb-2 bg-gray-900 text-white text-xs px-3 py-2 rounded whitespace-nowrap">
